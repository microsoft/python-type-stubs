...
def ttfFontProperty(font) -> FontEntry:
    """
...
class FontProperties:
    ...
    *font* kwarg of the `.Text` object.
    ...
    def __init__(
        self,
        family: Optional[Union[list[str], str]] = ...,
        style: None = ...,
        variant: None = ...,
        weight: Optional[str] = ...,
        stretch: None = ...,
        size: Optional[Union[int, float, str]] = ...,
        fname: Optional[PosixPath] = ...,
    ...
    def get_fontconfig_pattern(self) -> str:
        ...
        """
        ...
    def set_family(self, family: Optional[Union[list[str], str]]) -> None:
        """
    ...
    def set_variant(self, variant: Optional[str]) -> None:
        ...
        """
        ...
    def set_weight(self, weight: Optional[str]) -> None:
        """
        Set the font weight.
...
'extra bold', 'black'}, default: :rc:`font.weight`
        ...
        """
        ...
    def set_stretch(self, stretch: None) -> None:
        """
...
'ultra-expanded'}, default: :rc:`font.stretch`
        ...
        """
        ...
    def set_size(self, size: Optional[Union[int, float, str]]) -> None:
        """
        Set the font size.
...
'large', 'x-large', 'xx-large'}, default: :rc:`font.size`
        ...
        """
        ...
    def set_file(self, file: Optional[PosixPath]) -> None:
        """
    ...
    def get_math_fontfamily(self) -> str:
        ...
        """
        ...
    def set_math_fontfamily(self, fontfamily: Optional[str]) -> None:
        """
