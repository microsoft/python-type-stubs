...
-> (float, float)
        """
        ...
    def get_offset(self, width, height, xdescent, ydescent, renderer: RendererBase):
        """
...
class PaddedBox(OffsetBox):
    ...
    def get_extent_offsets(self, renderer: RendererBase) -> list: ...
    def draw(self, renderer): ...
    def update_frame(self, bbox, fontsize=...): ...
...
class AnnotationBbox(Artist, mtext._AnnotationBase):
    """
