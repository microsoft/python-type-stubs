...
from . import _api, _docstring, cbook, rcParams
from matplotlib.backend_bases import FigureCanvasBase
...
def axes(arg: None | tuple = ..., **kwargs):
    """
...
def subplot_tool(targetfig=...) -> SubplotTool:
    """
...
def xticks(ticks: ArrayLike = ..., labels: ArrayLike = ..., **kwargs):
    """
...
def yticks(ticks: ArrayLike = ..., labels: ArrayLike = ..., **kwargs):
    """
...
def rgrids(
    radii=..., labels: None = ..., angle: float = ..., fmt: str | None = ..., **kwargs
):
    """
...
def thetagrids(angles=..., labels: None = ..., fmt: str | None = ..., **kwargs):
    """
...
def colorbar(mappable=..., cax: Axes = ..., ax=..., **kwargs): ...
def clim(vmin=..., vmax=...):
    """
...
def matshow(
    A, fignum: None | int | Literal[False] = ..., **kwargs
...
def contour(*args, data=..., **kwargs) -> contour.QuadContourSet: ...
def contourf(*args, data=..., **kwargs) -> contour.QuadContourSet: ...
def csd(
    x: Sequence,
    y: Sequence,
    NFFT: int = ...,
...
def spy(
    ...
    origin: Literal["upper", "lower"] = ...,
    **kwargs
) -> tuple[matplotlib.image.AxesImage, Line2D]: ...
def stackplot(
    x,
    *args,
    labels: list[str] = ...,
