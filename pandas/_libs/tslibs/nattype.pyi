...
class NaTType(_NaT):
    ...
    def round(self, freq: str, ambiguous: Union[bool, Literal['raise', 'NaT']] = ...,
        nonexistent: Union[Literal['raise', 'shift_forward', 'shift_backward', 'NaT'], timedelta] = ...) -> Timestamp: ...
    ...
    def tz_localizel(self, tz: Any, ambiguous: Union[bool, Literal['raise', 'NaT']] = ...,
        nonexistent: Union[Literal['raise', 'shift_forward', 'shift_backward', 'NaT'], timedelta] = ...) -> Timestamp: ...
