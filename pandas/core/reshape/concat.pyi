...
@overload
def concat(objs: Union[Iterable[Optional[Series]], Mapping[Optional[Hashable], Optional[Series]]], join: str=..., ignore_index: bool=..., keys=..., levels=..., names=..., verify_integrity: bool=..., sort: bool=..., copy: bool=..., axis: Literal[0,'index']) -> Series[Dtype]: ...
@overload
def concat(objs: Union[Iterable[Optional[Series]], Mapping[Optional[Hashable], Optional[Series]]], join: str=..., ignore_index: bool=..., keys=..., levels=..., names=..., verify_integrity: bool=..., sort: bool=..., copy: bool=..., axis:Literal[1,'columns']) -> DataFrame: ...
@overload
