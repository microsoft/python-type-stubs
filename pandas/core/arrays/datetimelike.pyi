...
class DatetimeLikeArrayMixin(ExtensionOpsMixin, AttributesMixin, ExtensionArray):
    ...
    def copy(self): ...
    def shift(self, periods: int = ..., fill_value: Optional = ..., axis: int = ...): ...
    ...
    def min(self, axis: Optional = ..., skipna: bool = ..., *args, **kwargs): ...
    def max(self, axis: Optional = ..., skipna: bool = ..., *args, **kwargs): ...
