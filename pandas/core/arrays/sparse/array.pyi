...
class SparseArray(PandasObject, ExtensionArray, ExtensionOpsMixin):
    def __init__(self, data, sparse_index: Optional = ..., index: Optional = ..., fill_value: Optional = ..., kind: str = ..., dtype: Optional = ..., copy: bool = ...) -> None: ...
    @classmethod
    ...
    def shift(self, periods: int = ..., fill_value: Optional = ...): ...
    def unique(self): ...
    def factorize(self, na_sentinel: int = ...): ...
    def value_counts(self, dropna: bool = ...): ...
    def __getitem__(self, key): ...
    def take(self, indices, allow_fill: bool = ..., fill_value: Optional = ...): ...
    def searchsorted(self, v, side: str = ..., sorter: Optional = ...): ...
    def copy(self): ...
    def astype(self, dtype: Optional = ..., copy: bool = ...): ...
    def map(self, mapper): ...
    def to_dense(self): ...
    def nonzero(self): ...
    def all(self, axis: Optional = ..., *args, **kwargs): ...
...
def make_sparse(arr, kind: str = ..., fill_value: Optional = ..., dtype: Optional = ..., copy: bool = ...): ...
