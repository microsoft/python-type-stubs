...
class DatetimeArray(dtl.DatetimeLikeArrayMixin, dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    def __init__(self, values, dtype = ..., freq: Optional = ..., copy: bool = ...) -> None: ...
    @property
    ...
    def normalize(self): ...
    def to_period(self, freq: Optional = ...): ...
    def to_perioddelta(self, freq): ...
    def month_name(self, locale: Optional = ...): ...
    def day_name(self, locale: Optional = ...): ...
    @property
    def time(self): ...
    @property
    def timetz(self): ...
...
def sequence_to_dt64ns(data, dtype: Optional = ..., copy: bool = ..., tz: Optional = ..., dayfirst: bool = ..., yearfirst: bool = ..., ambiguous: str = ...): ...
