...
import numpy as np
from pandas._typing import _str, _T, _U
from pandas.core.arrays import ExtensionArray
from pandas.core.base import IndexOpsMixin, PandasObject
from pandas.core.strings import StringMethods
from typing import Any, Dict, Generic, Hashable, Iterable, Iterator, List, Optional, Tuple, Type, TypeVar, Union, overload

class InvalidIndexError(Exception): ...


class Index(IndexOpsMixin[_T], PandasObject, Generic[_T]):
    @property
    ...
    def __add__(self, other: Any) -> Index[_T]: ...
    def __radd__(self, other: Any) -> Index[_T]: ...
    def __iadd__(self, other: Any) -> Index[_T]: ...
    def __sub__(self, other: Any) -> Index[_T]: ...
    def __rsub__(self, other: Any) -> Index[_T]: ...
    def __and__(self, other: Any) -> Index[_T]: ...
    def __or__(self, other: Any) -> Index[_T]: ...
    def __xor__(self, other: Any) -> Index[_T]: ...
    def __nonzero__(self) -> None: ...
    __bool__: Any = ...
    def union(self, other: Union[List[_T], Index[_T]], sort: Optional[Any] = ...) -> Index[_T]: ...
    def intersection(self, other: Union[List[_T], Index[_T]], sort: bool = ...) -> Index[_T]: ...
    def difference(self, other: Union[List[_T], Index[_T]]) -> Index[_T]: ...
    def symmetric_difference(self, other: Union[List[_T], Index[_T]], result_name: Optional[Any] = ..., sort: Optional[Any] = ...) -> Index[_T]: ...
    ...
    def join(self, other: Any, how: _str = ..., level: Optional[Any] = ..., return_indexers: bool = ..., sort: bool = ...): ...
    @property
    ...
    @overload
    def __getitem__(self, idx: Union[int, Series[bool], slice, np.ndarray]) -> _T: ...
    @overload
    def __getitem__(self, idx: Index[_T]) -> Index[_T]: ...
    @overload
    def __getitem__(self, idx: Tuple[np.ndarray, ...]) -> _T: ...
    ...
    def drop(self, labels: Any, errors: _str = ...): ...
    @property
