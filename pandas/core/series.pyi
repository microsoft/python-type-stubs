...
from pandas._typing import AxisType as AxisType, Dtype as Dtype, DtypeNp as DtypeNp, FilePathOrBuffer as FilePathOrBuffer, Level as Level, MaskType as MaskType, S1 as S1, Scalar as Scalar, SeriesAxisType as SeriesAxisType, num as num
...
class Series(IndexOpsMixin, NDFrame, Generic[S1]):
    ...
    def iteritems(self) -> Iterable[Tuple[Union[int, _str], S1]]: ...
    def keys(self) -> List: ...
