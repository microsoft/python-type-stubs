...
class OpsMixin:
    ...
    def __divmod__(self: OpsMixinProtocol, other: Any) -> Tuple[FrameOrSeries, FrameOrSeries]: ...
    def __rdivmod__(self: OpsMixinProtocol, other: Any) -> Tuple[FrameOrSeries, FrameOrSeries]: ...
