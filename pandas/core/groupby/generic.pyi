...
from matplotlib import AxesSubplot, axes
import numpy as np
import sys
from pandas._libs import Timestamp as Timestamp, lib as lib
from pandas._typing import FrameOrSeries as FrameOrSeries, _AxisType, _DType, _LevelType
...
from typing import Any, Callable, Dict, FrozenSet, Optional, Sequence, Tuple, Type, Union, overload
...
class SeriesGroupBy(GroupBy):
    ...
    def nth(self, n: Union[int, Sequence[int]], dropna: Optional[str] = ...) -> Series[_DType]: ...
...
class DataFrameGroupBy(GroupBy):
    ...
    def take(self, indices: Sequence, axis: _AxisType = ..., **kwargs) -> DataFrame: ...
