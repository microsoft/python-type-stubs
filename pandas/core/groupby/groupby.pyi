...
class _GroupBy(PandasObject, SelectionMixin):
    ...
    grouper: Any = ...
    exclusions: Any = ...
    def __init__(self, obj: NDFrame, keys: Optional[KeysArgType]=..., axis: int=..., level: Any=..., grouper: Optional[ops.BaseGrouper]=..., exclusions: Any=..., selection: Any=..., as_index: bool=..., sort: bool=..., group_keys: bool=..., squeeze: bool=..., observed: bool=..., mutated: bool=...) -> None: ...
...
def get_groupby(obj: NDFrame, by: Optional[KeysArgType]=..., axis: int=..., level: Any=..., grouper: Optional[ops.BaseGrouper]=..., exclusions: Any=..., selection: Any=..., as_index: bool=..., sort: bool=..., group_keys: bool=..., squeeze: bool=..., observed: bool=..., mutated: bool=...) -> GroupBy: ...
