...
class Term:
    def __new__(cls, name, env, side: Optional = ..., encoding: Optional = ...): ...
    is_local: bool
    env = ...
    side = ...
    encoding = ...
    def __init__(self, name, env, side: Optional = ..., encoding: Optional = ...) -> None: ...
    @property
...
class Constant(Term):
    def __init__(self, value, env, side: Optional = ..., encoding: Optional = ...) -> None: ...
    @property
    def name(self): ...
