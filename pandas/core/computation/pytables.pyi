...
class PyTablesScope(_scope.Scope):
    ...
    def __init__(self, level: int, global_dict=..., local_dict=..., queryables: Optional[Dict[str,]]=...) -> None: ...
...
class BinOp(ops.BinOp):
    ...
    encoding = ...
    condition = ...
    def __init__(self, op: str, lhs, rhs, queryables: Dict[str,], encoding) -> None: ...
