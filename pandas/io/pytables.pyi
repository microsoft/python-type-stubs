...
from pandas._typing import ArrayLike as ArrayLike, FilePathOrBuffer as FilePathOrBuffer, FrameOrSeries as FrameOrSeries, FrameOrSeriesUnion
...
def to_hdf(path_or_buf: FilePathOrBuffer, key: str, value: FrameOrSeriesUnion, mode: str=..., complevel: Optional[int]=..., complib: Optional[str]=..., append: bool=..., format: Optional[str]=..., index: bool=..., min_itemsize: Optional[Union[int, Dict[str, int]]]=..., nan_rep=..., dropna: Optional[bool]=..., data_columns: Optional[List[str]]=..., errors: str=..., encoding: str=...) : ...
def read_hdf(
...
class HDFStore:
    ...
    def put(self, key: str, value: FrameOrSeriesUnion, format=..., index=..., append=..., complib=..., complevel: Optional[int]=..., min_itemsize: Optional[Union[int, Dict[str, int]]]=..., nan_rep=..., data_columns: Optional[List[str]]=..., encoding=..., errors: str=...) : ...
    def remove(self, key: str, where=..., start=..., stop=...) : ...
    def append(self, key: str, value: FrameOrSeriesUnion, format=..., axes=..., index=..., append=..., complib=..., complevel: Optional[int]=..., columns=..., min_itemsize: Optional[Union[int, Dict[str, int]]]=..., nan_rep=..., chunksize=..., expectedrows=..., dropna: Optional[bool]=..., data_columns: Optional[List[str]]=..., encoding=..., errors: str=...) : ...
