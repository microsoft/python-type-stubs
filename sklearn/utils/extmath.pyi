...
def safe_sparse_dot(
    a: NDArray, b: NDArray, *, dense_output: bool = False
) -> NDArray: ...
...
def _safe_accumulator_op(
    op: Callable, x: ndarray, *args, **kwargs
...
def stable_cumsum(
    arr: ArrayLike, axis: int | None = None, rtol: float = 1e-05, atol: float = 1e-08
) -> ndarray: ...
