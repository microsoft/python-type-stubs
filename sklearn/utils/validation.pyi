...
def _ensure_no_complex_data(
    array: Union[csc_matrix, csr_matrix, coo_matrix, ndarray]
) -> None: ...
...
def _check_large_sparse(
    X: Union[csc_matrix, csr_matrix, coo_matrix], accept_large_sparse: bool = False
) -> None: ...
def check_X_y(
    X: NDArray | list,
    y: NDArray | list,
...
def _check_psd_eigenvalues(
    lambdas: ndarray, enable_warnings: bool = False
) -> ndarray: ...
