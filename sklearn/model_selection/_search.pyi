...
class ParameterGrid:
    def __init__(
        self, param_grid: Mapping[str, Sequence] | Sequence[Mapping[str, Sequence]]
    ) -> None: ...
...
def _check_refit(
    search_cv: Union[RandomizedSearchCV, HalvingRandomSearchCV, GridSearchCV], attr: str
) -> None: ...
...
class BaseSearchCV(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def _check_refit_for_multimetric(
        self, scores: Dict[str, Union[_ThresholdScorer, _PredictScorer]]
    ) -> None: ...
    @staticmethod
    ...
    def fit(
        ...
        **fit_params,
        ...
        HalvingRandomSearchCV, RandomizedSearchCV, HalvingGridSearchCV, GridSearchCV
    ]: ...
    def _format_results(
        self,
