...
class GroupKFold(_BaseKFold):
    ...
    def _iter_test_indices(
        self, X: ndarray, y: ndarray, groups: ndarray
    ) -> Iterator[ndarray]: ...
    def split(
        self, X: ArrayLike, y: ArrayLike | None = None, groups: ArrayLike | None = None
    ) -> Iterator[Any]: ...
...
class StratifiedKFold(_BaseKFold):
    ...
    def _make_test_folds(
        self, X: Union[ndarray, List[str]], y: Optional[ndarray] = None
    ) -> ndarray: ...
    def _iter_test_masks(
        self,
    ...
    def split(
        self, X: ArrayLike, y: ArrayLike, groups: Optional[ndarray] = None
    ) -> Iterator[Any]: ...
...
class StratifiedGroupKFold(_BaseKFold):
    ...
    def _find_best_fold(
        self, y_counts_per_fold: ndarray, y_cnt: ndarray, group_y_counts: ndarray
    ) -> int: ...
...
class LeaveOneGroupOut(BaseCrossValidator):
    ...
    def get_n_splits(
        self, X: Any = None, y: Any = None, groups: ArrayLike | None = None
    ) -> int: ...
    def split(
        self, X: ArrayLike, y: ArrayLike | None = None, groups: ArrayLike | None = None
    ): ...
