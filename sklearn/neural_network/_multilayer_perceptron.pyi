...
class BaseMultilayerPerceptron(BaseEstimator, metaclass=ABCMeta):
    ...
    def _fit(
        self, X: ndarray, y: ndarray, incremental: bool = False
    ) -> Union[MLPRegressor, MLPClassifier]: ...
    ...
    def _update_no_improvement_count(
        self, early_stopping: bool, X_val: None, y_val: None
    ) -> None: ...
...
class MLPClassifier(ClassifierMixin, BaseMultilayerPerceptron):
    ...
    def _validate_input(
        self, X: ndarray, y: ndarray, incremental: bool, reset: bool
    ) -> Tuple[ndarray, ndarray]: ...
    def predict(self, X: NDArray | ArrayLike) -> NDArray: ...
    @available_if(lambda est: est._check_solver())
    def partial_fit(
        self, X: NDArray | ArrayLike, y: ArrayLike, classes: ArrayLike | None = None
    ) -> Any: ...
