...
class _BaseEncoder(TransformerMixin, BaseEstimator):
    def _check_X(
        self, X: Union[DataFrame, ndarray], force_all_finite: str|bool = True
    ) -> Tuple[List[ndarray], int, int]: ...
    def _get_feature(
        self, X: Union[DataFrame, ndarray], feature_idx: int
...
class OneHotEncoder(_BaseEncoder):
    ...
    def _compute_transformed_categories(
        self, i: int, remove_dropped: bool = True
    ) -> ndarray: ...
    def _remove_dropped_categories(self, categories: ndarray, i: int) -> ndarray: ...
    def _compute_n_features_outs(self) -> List[int]: ...
    def fit(
        self, X: ArrayLike, y: Optional[Union[ndarray, List[int]]] = None
    ) -> "OneHotEncoder": ...
    def fit_transform(
        self, X: ArrayLike, y: Optional[Union[List[int], ndarray]] = None
    ) -> NDArray: ...
