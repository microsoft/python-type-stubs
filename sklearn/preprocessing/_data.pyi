...
def _is_constant_feature(
    var: ndarray, mean: ndarray, n_samples: Union[int64, int]
) -> ndarray: ...
...
class StandardScaler(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def inverse_transform(
        self, X: NDArray | ArrayLike, copy: bool | None = None
    ) -> NDArray: ...
    def _more_tags(
        self,
...
def binarize(
    X: NDArray | ArrayLike, *, threshold: float = 0.0, copy: bool = True
) -> NDArray: ...
...
class QuantileTransformer(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def _transform_col(
        self, X_col: ndarray, quantiles: ndarray, inverse: bool
    ) -> ndarray: ...
    def _check_inputs(
        self,
        X: ndarray,
...
class PowerTransformer(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def _fit(
        self, X: ndarray, y: None = None, force_transform: bool = False
    ) -> ndarray: ...
    def transform(self, X: ArrayLike) -> NDArray: ...
    def inverse_transform(self, X: ArrayLike) -> NDArray: ...
    ...
    def _yeo_johnson_transform(
        self, x: ndarray, lmbda: Union[int, float, float64]
    ) -> ndarray: ...
