...
class _PLS(
    ...
    def transform(self, X: MatrixLike, Y: None | MatrixLike = None, copy: bool = True):
        ...
...
class PLSSVD(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X: MatrixLike, Y: None | MatrixLike | ArrayLike = None):
        ...

    def fit_transform(self, X: MatrixLike, y: None | MatrixLike | ArrayLike = None):
        ...
