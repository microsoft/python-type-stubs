...
def check_paired_arrays(
    X: NDArray | ArrayLike, Y: NDArray | ArrayLike
) -> tuple[NDArray | ArrayLike, NDArray | ArrayLike]: ...
...
def manhattan_distances(
    X: ArrayLike, Y: ArrayLike | None = None, *, sum_over_features: bool = True
) -> np.ndarray: ...
def cosine_distances(
    X: NDArray | ArrayLike, Y: NDArray | ArrayLike | None = None
) -> np.ndarray: ...
...
def paired_distances(
    X: NDArray, Y: NDArray, *, metric: str | Callable = "euclidean", **kwds
) -> NDArray: ...

# Kernels
def linear_kernel(
    X: NDArray, Y: NDArray | None = None, dense_output: bool = True
) -> np.ndarray: ...
...
def sigmoid_kernel(
    X: NDArray, Y: NDArray | None = None, gamma: float | None = None, coef0: float = 1
) -> np.ndarray: ...
def rbf_kernel(
    X: NDArray, Y: NDArray | None = None, gamma: float | None = None
) -> np.ndarray: ...
...
def chi2_kernel(
    X: ArrayLike, Y: NDArray | None = None, gamma: float = 1.0
) -> np.ndarray: ...
...
def _check_chunk_size(
    reduced: Optional[Union[Tuple[ndarray, ndarray], ndarray]], chunk_size: int
) -> None: ...
