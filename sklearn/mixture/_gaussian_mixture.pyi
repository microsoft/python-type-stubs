...
def _compute_precision_cholesky(
    covariances: ndarray, covariance_type: str
) -> ndarray: ...

###############################################################################
# Gaussian mixture probability estimators
def _compute_log_det_cholesky(
    matrix_chol: ndarray, covariance_type: str, n_features: int
) -> Union[ndarray, float64]: ...
def _estimate_log_gaussian_prob(
    X: ndarray, means: ndarray, precisions_chol: ndarray, covariance_type: str
) -> ndarray: ...
...
class GaussianMixture(BaseMixture):
    ...
    def _set_parameters(
        self, params: Tuple[ndarray, ndarray, ndarray, ndarray]
    ) -> None: ...
