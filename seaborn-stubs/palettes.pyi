...
def color_palette(palette=..., n_colors=..., desat=..., as_cmap=...) -> _ColorPalette | list[tuple[float, float, float]] | list[str] | mpl.colors.ListedColormap | mpl.colors.LinearSegmentedColormap: ...
