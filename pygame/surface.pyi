...
class Surface(object):
    ...
    @overload
    def blit(self, source: Surface, dest: Sequence[float], area: Optional[Rect] = ..., special_flags: int = ...) -> Rect:
        ...

    @overload
    def blit(self, source: Surface, dest: Rect, area: Optional[Rect] = ..., special_flags: int = ...) -> Rect:
        ...

    @overload
    def blits(self, sequence: Sequence[Surface], doreturn: int) -> Union[Sequence[Rect], None]:
        ...

    @overload
    def blits(self, sequence: Sequence[Surface], doreturn: bool) -> Union[Sequence[Rect], None]:
        ...

    @overload
    def blits(self, sequence: Sequence[Rect], doreturn: int) -> Union[Sequence[Rect], None]:
        ...

    @overload
    def blits(self, sequence: Sequence[Rect], doreturn: bool) -> Union[Sequence[Rect], None]:
        ...
