from typing import Any, Mapping, Optional, Sequence, Union, overload, Tuple, SupportsInt
...
def pump() -> None: ...
def get(eventtype: _EventTypes = ..., pump: Any = ...) -> Sequence[Event]: ...
def poll() -> Event: ...
def wait() -> Event: ...
def peek(eventtype: _EventTypes = ..., pump: Any = ...) -> bool: ...
def clear(eventtype: _EventTypes = ..., pump: Any = ...) -> None: ...
