...
class SeriesGroupBy(GroupBy):
    ...
    def bfill(self, limit: Optional[int] = ...) -> Series: ...
    def cummax(self, axis: AxisType = ..., **kwargs) -> Series: ...
    def cummin(self, axis: AxisType = ..., **kwargs) -> Series: ...
    def cumprod(self, axis: AxisType = ..., **kwargs) -> Series: ...
    def cumsum(self, axis: AxisType = ..., **kwargs) -> Series: ...
    def ffill(self, limit: Optional[int] = ...) -> Series: ...
    def first(self, **kwargs) -> Series: ...
    def head(self, n: int = ...) -> Series: ...
    def last(self, **kwargs) -> Series: ...
    def max(self, **kwargs) -> Series: ...
    def mean(self, **kwargs) -> Series: ...
    def median(self, **kwargs) -> Series: ...
    def min(self, **kwargs) -> Series: ...
    def nlargest(self, n: int = ..., keep: str = ...) -> Series: ...
    def nsmallest(self, n: int = ..., keep: str = ...) -> Series: ...
    def nth(self, n: Union[int, Sequence[int]], dropna: Optional[str] = ...) -> Series: ...
