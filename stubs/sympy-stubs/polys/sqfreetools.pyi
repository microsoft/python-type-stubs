...
def dmp_sqf_norm(f, u, K) -> tuple[int, Any | list[Any], tuple[Any, list[Any]] | Any | tuple[list[list[Any]], list[Any]] | tuple[list[list[Any]] | Any | list[Any], list[Any]] | list[list[Any]] | list[Any]] | tuple[int, Any | list[Any] | list[list[Any]], tuple[Any, list[Any]] | Any | tuple[list[list[Any]], list[Any]] | tuple[list[list[Any]] | Any | list[Any], list[Any]] | list[list[Any]] | list[Any]]:
    ...
...
def dmp_sqf_list_include(f, u, K, all=...) -> list[tuple[list[Any], Literal[1]]] | list[tuple[Any, Literal[1]]] | list[tuple[list[list[Any]] | Any | list[Any], Literal[1]]]:
    ...
