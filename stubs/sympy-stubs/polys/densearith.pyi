...
def dmp_pdiv(f, g, u, K) -> tuple[list[Any], Any] | tuple[list[Any], list[Any]] | tuple[list[list[Any]], Any] | tuple[list[Any] | Any | list[list[Any]] | list[Any | list[Any] | list[list[Any]]], list[Any] | Any | list[list[Any]] | list[Any | list[Any] | list[list[Any]]]]:
    ...
...
def dmp_rr_div(f, g, u, K) -> tuple[list[Any], Any] | tuple[Any | list[Any], Any | list[Any]] | tuple[list[list[Any]], Any] | tuple[list[list[Any]] | Any, Any | list[Any] | list[list[Any]]]:
    ...

def dup_ff_div(f, g, K) -> tuple[list[Any], Any] | tuple[Any, list[Any] | Any]:
    ...

def dmp_ff_div(f, g, u, K) -> tuple[list[Any], Any] | tuple[Any, list[Any] | Any] | tuple[list[list[Any]], Any] | tuple[list[list[Any]] | Any, Any | list[Any] | list[list[Any]]]:
    ...
...
def dmp_div(f, g, u, K) -> tuple[list[Any], Any] | tuple[Any, list[Any] | Any] | tuple[list[list[Any]], Any] | tuple[list[list[Any]] | Any, Any | list[Any] | list[list[Any]]] | tuple[Any | list[Any], Any | list[Any]]:
    ...
