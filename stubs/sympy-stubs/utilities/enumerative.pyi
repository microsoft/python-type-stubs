...
def multiset_partitions_taocp(multiplicities) -> Generator[list[Any]]: ...
...
class MultisetPartitionTraverser:
    ...
    def enum_all(self, multiplicities) -> Generator[list[Any]]: ...
    def enum_small(self, multiplicities, ub) -> Generator[list[Any]]: ...
    def enum_large(self, multiplicities, lb) -> Generator[list[Any]]: ...
    def enum_range(self, multiplicities, lb, ub) -> Generator[list[Any]]: ...
