...
def join(inputs: Sequence[TensorCompatible], separator: str = "", name: str | None = None) -> Tensor: ...

# None corresponds to "" for split.
def split(
    input: TensorCompatible, sep: str | None = None, maxsplit: int = -1, name: str | None = None
) -> RaggedTensor: ...
@overload
def as_string(
